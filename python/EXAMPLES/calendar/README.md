...
Remenber that without a client key to login, only a sample of data will be provided.

#**calendarEx**

Shows how to get data with diferent parameters, and output types.

*You can get pandas DataFrame output:*
```
...
Is a simple App where you can use the data from the calendar by showing it on an html page.
...
Running the App it will give you an *Ip adress* to run on your browser:

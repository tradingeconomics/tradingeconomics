...
Download the [Trading Economics Excel Add In](https://github.com/ieconomics/open-api/raw/master/Excel/All_Releases/ExcelAddInDeploy_v1.2.1.msi) installer, launch it and follow the instructions.    
...
<blockquote class="lang-specific python">
<p>To start using the Trading Economics Python package, type in command window:</p>
</blockquote>
```python
...
<blockquote class="lang-specific shell">
<p>Click Latest button on TE ribbon and then follow the instructions in the dialog box.    
...
```shell
=TEForecasts( "United States", "GDP", "Country,Category,LatestValue,LatestValueDate,YearEnd,YearEnd2,q1,q1_date,q4,q4_date", B2)Men
```

...
te.getIndicatorData().then(all => {
  console.log('List of all Indicators', '\n', all, '\n',)       
}).catch(err => console.log(err));

//===============================================================================================================
// Get an indicators list by country or countries

te.getIndicatorData(country = ['united states','china']).then(country => {
  console.log('List of indicators by country', '\n', country, '\n',)       
}).catch(err => console.log(err))

//===============================================================================================================
// Get an indicators list by country and specific group
...
// Get specific indicator for all countries 
  ...
  te.getIndicatorData(indicator = 'gdp').then(indicator => {
...
// Get a list of indicators by ticker
  ...
  te.getIndicatorData(ticker = 'usurtot').then(ticker => {
